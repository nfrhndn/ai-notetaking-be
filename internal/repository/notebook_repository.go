...
type INotebookRepository interface {
	...
	NulifyParentIdById(ctx context.Context, parentId uuid.UUID) error
...
func (n *notebookRepository) NulifyParentIdById(ctx context.Context, parentId uuid.UUID) error {
	_, err := n.db.Exec(
		ctx,
